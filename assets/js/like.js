$(function(){
    $(document).on('click','.like-btn', function(){
        ...
        $.post('http://localhost/twitter_clone/includes/ajax/like.php', {like:tweet_id, user_id:user_id}, function(){
            counter.show();
    ...
    $(document).on('click','.unlike-btn', function(){
        ...
        $.post('http://localhost/twitter_clone/includes/ajax/like.php', {unlike:tweet_id, user_id:user_id}, function(){
            counter.show();
